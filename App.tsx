...
const App: React.FC = () => {
  ...
  const NavItem: React.FC<{
    ...
    return (
      <button
        onClick={handleClick}
        className={`flex flex-col md:flex-row items-center justify-center md:justify-start flex-1 md:flex-initial py-2 px-1 md:p-3 md:my-1 rounded-lg text-xs md:text-sm transition-all duration-200 ${view === targetView
    ...
    <div className="flex flex-col md:flex-row h-screen font-sans bg-slate-900 text-slate-200">
      <nav className="order-last md:order-none w-full md:w-56 bg-slate-800/50 p-1 md:p-3 flex flex-row md:flex-col gap-1 md:justify-start shrink-0 border-t-2 md:border-t-0 md:border-r-2 border-slate-700">
        <div className="hidden md:block text-center mb-6">
          <h1 className="text-2xl font-bold text-white">MENTAL HEALTH JOURNAL MVP</h1>
